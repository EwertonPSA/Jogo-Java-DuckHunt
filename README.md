...
## Descrição do jogo
O jogo implementado foi baseado no título Duck Hunt da Nintendo, porém foram realizadas modificações estéticas, na jogabilidade e na lógica, além de um novo modo multiplayer, em que um player assume o papel do pato (que tem que desviar dos tiros do caçador) e o segundo player assume o papel do caçador. Foi criado uma [documentação](https://github.com/EwertonPSA/Jogo-Java-DuckHunt/blob/master/Documenta%C3%A7%C3%A3o.pdf) descrevendo todo o projeto.
...
## Notas sobre o jogo
1) O executável [Duck Hunter.jar](https://github.com/EwertonPSA/Jogo-Java-DuckHunt/blob/master/Duck%20Hunt.jar) necessita dos sprints e musicas externas criadas, assim todos os arquivos para sua execução se encontram reunidos em [Executavel do Duck Hunt.zip](https://github.com/EwertonPSA/Jogo-Java-DuckHunt/blob/master/Executavel%20do%20Duck%20Hunt.zip).
